      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="card shadow">
          ...
          <form method="POST" action="{{ route('register') }}">
              ...
              <div class="d-grid">
                <button type="submit" class="btn text-light main-bg">{{ __('Register') }}</button>
                <p class="text-center">Have already an account? <a href="{{url('/login')}}">{{ __('Login') }}</a></p>
              </div>
            </form>
          </div>
        </div>
